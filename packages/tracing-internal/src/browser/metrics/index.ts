...
import type { IdleTransaction, Transaction } from '@monitor-web/core';
import { getActiveTransaction } from '@monitor-web/core';
import type { Measurements } from '@monitor-web/types';
import { browserPerformanceTimeOrigin, htmlTreeAsString, logger } from '@monitor-web/utils';
