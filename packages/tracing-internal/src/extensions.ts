import { addTracingExtensions, getMainCarrier } from '@monitor-web/core';
import type { Integration, IntegrationClass } from '@monitor-web/types';
import { dynamicRequire, isNodeEnv, loadModule } from '@monitor-web/utils';
