import { GLOBAL_OBJ } from '@monitor-web/utils';

// exporting a separate copy of `WINDOW` rather than exporting the one from `@monitor-web/browser`
// prevents the browser package from being bundled in the CDN bundle, and avoids a
// circular dependency between the browser and replay packages should `@monitor-web/browser` import
// from `@monitor-web/replay` in the future
