import type { BaseClient } from '@monitor-web/core';
import { addGlobalEventProcessor, getCurrentHub } from '@monitor-web/core';
import type { Client, DynamicSamplingContext } from '@monitor-web/types';
import { addInstrumentationHandler } from '@monitor-web/utils';
