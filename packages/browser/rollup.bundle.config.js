...
targets.forEach(jsVersion => {
  const baseBundleConfig = makeBaseBundleConfig({
    ...
    jsVersion,
    licenseTitle: '@monitor-web/browser',
  ...
  const tracingBaseBundleConfig = makeBaseBundleConfig({
    ...
    jsVersion,
    licenseTitle: '@monitor-web/browser & @monitor-web/tracing',
...
if (targets.includes('es6')) {
  ...
  const replayBaseBundleConfig = makeBaseBundleConfig({
    ...
    jsVersion: 'es6',
    licenseTitle: '@monitor-web/browser & @monitor-web/replay',
  ...
  const tracingReplayBaseBundleConfig = makeBaseBundleConfig({
    ...
    jsVersion: 'es6',
    licenseTitle: '@monitor-web/browser & @monitor-web/tracing & @monitor-web/replay',
