...
import { DEFAULT_ENVIRONMENT, getCurrentHub } from '@monitor-web/core';
import type { DebugImage, Envelope, Event, StackFrame, StackParser } from '@monitor-web/types';
import type { Profile, ThreadCpuProfile } from '@monitor-web/types/src/profiling';
import { browserPerformanceTimeOrigin, forEachEnvelopeItem, GLOBAL_OBJ, logger, uuid4 } from '@monitor-web/utils';
