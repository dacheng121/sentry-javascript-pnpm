 ...
 * browser context. They live here in `@monitor-web/utils` rather than in `@monitor-web/node` so that they can be used in
 ...
 * Note that for now, the tests for this code have to live in `@monitor-web/node`, since they test both these functions and
