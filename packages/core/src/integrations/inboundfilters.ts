import type { Client, Event, EventHint, Integration, StackFrame } from '@monitor-web/types';
import { getEventDescription, logger, stringMatchesSomePattern } from '@monitor-web/utils';
