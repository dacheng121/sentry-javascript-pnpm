import type { Client, Event, EventHint, Integration, Options } from '@monitor-web/types';
import { arrayify, logger } from '@monitor-web/utils';

import { addGlobalEventProcessor } from './eventProcessors';
import { getCurrentHub } from './hub';

declare module '@monitor-web/types' {
