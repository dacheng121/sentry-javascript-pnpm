import type { Contexts, Event, EventHint, ExtendedError, Integration } from '@monitor-web/types';
import { addNonEnumerableProperty, isError, isPlainObject, logger, normalize } from '@monitor-web/utils';
