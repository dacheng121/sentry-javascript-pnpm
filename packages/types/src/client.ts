...
export interface Client<O extends ClientOptions = ClientOptions> {
  ...
  /**
   * Register a callback when an OpenTelemetry span is ended (in @monitor-web/opentelemetry-node).
  ...
  /**
   * Fire a hook for when an OpenTelemetry span is ended (in @monitor-web/opentelemetry-node).
